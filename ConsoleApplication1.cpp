...
//която за даден едномерен масив Arr от дробни числа и дължина на масива N, 
//връща нов масив който съдържа числата от първият, които са с нечетни индекси 
//и стойност по-малка от средната стойност на Arr.
...
//Task2
//Да се напише функция на C++, която приема като параметър едномерен масив 
//от цели числа и дължина на масива и връща като резултат 
//максималната сума на непрекъснат подмасив в него.
//
// Пояснения: Непрекъснат подмасив се нарича всяка последователност 
//от елементи в даден масив, които са съседни, 
//т.е.техните индекси са продължителни / непрекъснати.
...
//Task3
//Да се напише програма на C++, която за въведен от потребителя от стандартния 
//вход символен низ, намира броя на думите с четна дължина и го извежда на стандартния изход.
//
// Пояснения: Дума се нарича всяка последователност от символи, която 
//не включва интервал и / или табулация('\t') или е ограничена от началото и / или 
//края на низа.Броят на интервалите и табулациите не е ограничен.
...
//
// Пояснения: Дума се нарича всяка последователност от символи, която не включва интервал и / или табулация('\t') 
// или е ограничена от началото и / или края на низа.Броят на интервалите и табулациите не е ограничен.
// 
//ASCII стойност на дума е сумата на АSCII стойностите на всички символи от които се състои думата.
